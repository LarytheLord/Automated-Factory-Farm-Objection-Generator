...
export default function InternalAccessReviewPage() {
    ...
    return (
      <div className="min-h-screen bg-slate-50 text-slate-900 p-8">
        <div className="max-w-5xl mx-auto">
          <div className="glass-card p-6">Loading access review console...</div>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="glass-card p-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <h1 className="text-2xl md:text-3xl font-bold">Access Review Console</h1>
              <p className="text-slate-600 mt-1">
                Private admin endpoint for manual account approvals.
              </p>
            </div>
