...
const PERSONAS = {
    ...
    neighboring_farmer: {
        ...
        legalPriorities: {
            ...
            'Ireland': ['European Union (Good Agricultural Practice for Protection of Waters) Regulations 2022 (Nitrates)', 'Local Government (Water Pollution) Acts 1977 and 1990', 'EPA (Industrial Emissions) (Licensing) Regulations 2013'],
        },
    ...
    local_resident: {
        ...
        legalPriorities: {
            ...
            'Ireland': ['EPA (Industrial Emissions) (Licensing) Regulations 2013', 'Planning and Development Act 2000', 'Environmental Protection Agency Act 1992'],
        },
    ...
    small_business_owner: {
        ...
        legalPriorities: {
            ...
            'Ireland': ['European Union (Environmental Impact Assessment) Regulations', 'Planning and Development Act 2000', 'Aarhus Convention'],
        },
    ...
    public_health_advocate: {
        ...
        legalPriorities: {
            ...
            'Ireland': ['EPA (Industrial Emissions) (Licensing) Regulations 2013', 'European Communities (Water Policy) Regulations 2003 (Water Framework)', 'Environmental Protection Agency Act 1992'],
        },
    ...
    parent_or_caregiver: {
        ...
        legalPriorities: {
            ...
            'Ireland': ['European Communities (Water Policy) Regulations 2003 (Water Framework)', 'European Union (Good Agricultural Practice for Protection of Waters) Regulations 2022 (Nitrates)', 'European Union (Environmental Impact Assessment) Regulations'],
        },
    ...
    environmental_activist: {
        ...
        legalPriorities: {
            ...
            'Ireland': ['European Union (Environmental Impact Assessment) Regulations', 'Wildlife Acts 1976 to 2018', 'European Communities (Water Policy) Regulations 2003 (Water Framework)'],
        },
    ...
    water_resource_stakeholder: {
        ...
        legalPriorities: {
            ...
            'European Union': ['Water Framework Directive', 'Nitrates Directive'],
            'Ireland': ['European Communities (Water Policy) Regulations 2003 (Water Framework)', 'European Union (Good Agricultural Practice for Protection of Waters) Regulations 2022 (Nitrates)', 'Local Government (Water Pollution) Acts 1977 and 1990'],
        },
    ...
    transport_infrastructure: {
        ...
        legalPriorities: {
            ...
            'Ireland': ['Planning and Development Act 2000', 'European Union (Environmental Impact Assessment) Regulations'],
        },
    ...
    property_owner: {
        ...
        legalPriorities: {
            ...
            'European Union': ['Environmental Impact Assessment Directive', 'Aarhus Convention'],
            'Ireland': ['Planning and Development Act 2000', 'European Union (Environmental Impact Assessment) Regulations', 'Aarhus Convention'],
        },
    ...
    indigenous_or_tribal: {
        ...
        legalPriorities: {
            ...
            'Ireland': ['Aarhus Convention', 'European Union (Environmental Impact Assessment) Regulations', 'Wildlife Acts 1976 to 2018'],
        },
    ...
    environmental_justice: {
        ...
        legalPriorities: {
            ...
            'European Union': ['Aarhus Convention', 'Environmental Impact Assessment Directive'],
            'Ireland': ['Aarhus Convention', 'European Union (Environmental Impact Assessment) Regulations', 'Planning and Development Act 2000'],
        },
    ...
    veterinary_professional: {
        ...
        legalPriorities: {
            ...
            'Ireland': ['Animal Health and Welfare Act 2013', 'EPA (Industrial Emissions) (Licensing) Regulations 2013'],
        },
